/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 7cd4b3e510dab52c22a6658abc10ed0f)
// Runtime types generated with workerd@1.20250906.0 2025-08-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		R2_BUCKET_NAME: "files";
		ENABLE_AUTH: "true";
		ALLOWED_ORIGINS: "*";
		NEXTAUTH_URL: "https://files.uzair.me";
		NODE_ENV: "production";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME" | "ENABLE_AUTH" | "ALLOWED_ORIGINS" | "NEXTAUTH_URL" | "NODE_ENV" | "NEXTJS_ENV" | "CLOUDFLARE_ACCOUNT_ID" | "ADMIN_EMAILS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NEXTAUTH_SECRET">> {}
}
