...
const prepareUploadInput = z.object({
  smallFiles: z.array(z.object({
    key: z.string(),
  })),
  largeFiles: z.array(z.object({
    key: z.string(),
...
type PrepareUploadInput = inferProcedureInput<
  typeof upload.prepare
>;
type PrepareUploadOutput = Awaited<ReturnType<typeof upload.prepare>>;
type CompleteUploadInput = inferProcedureInput<
  typeof upload.complete
>;
